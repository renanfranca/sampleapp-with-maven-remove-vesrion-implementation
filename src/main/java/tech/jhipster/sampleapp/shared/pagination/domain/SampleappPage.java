...
public final class SampleappPage<T> {
  ...
  private SampleappPage(SampleappPageBuilder<T> builder) {
    content = SampleappCollections.immutable(builder.content);
  ...
  public static <T> SampleappPage<T> singlePage(List<T> content) {
    return builder(content).build();
  }

  public static <T> SampleappPageBuilder<T> builder(List<T> content) {
    return new SampleappPageBuilder<>(content);
  }

  public static <T> SampleappPage<T> of(List<T> elements, SampleappPageable pagination) {
  ...
  public <R> SampleappPage<R> map(Function<T, R> mapper) {
  ...
  public static final class SampleappPageBuilder<T> {
    ...
    private SampleappPageBuilder(List<T> content) {
      this.content = content;
    }

    public SampleappPageBuilder<T> pageSize(int pageSize) {
      this.pageSize = pageSize;

      return this;
    }

    public SampleappPageBuilder<T> currentPage(int currentPage) {
      this.currentPage = currentPage;

      return this;
    }

    public SampleappPageBuilder<T> totalElementsCount(long totalElementsCount) {
      this.totalElementsCount = totalElementsCount;

      return this;
    }

    public SampleappPage<T> build() {
      return new SampleappPage<>(this);
    }
  }
}
