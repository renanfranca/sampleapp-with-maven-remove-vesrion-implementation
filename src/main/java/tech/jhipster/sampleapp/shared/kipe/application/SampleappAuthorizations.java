...
import tech.jhipster.sampleapp.shared.authentication.application.AuthenticatedUser;
...
import tech.jhipster.sampleapp.shared.kipe.domain.Action;
...
@Component
public class SampleappAuthorizations {

  private final RolesAccesses accesses;

  public SampleappAuthorizations(Collection<RolesAccesses> accesses) {
