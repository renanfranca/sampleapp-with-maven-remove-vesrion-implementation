...
import static tech.jhipster.sampleapp.shared.kipe.domain.RolesAccessesFixture.*;
...
import tech.jhipster.sampleapp.shared.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class SampleappAuthorizationsTest {

  private static final SampleappAuthorizations authorizations = new SampleappAuthorizations(List.of(rolesAccesses()));
